  ...
  return (
    <Box className="homepage-map">
      <Box className="homepage-map-filter">
        ...
        <Autocomplete multiple options={siteNameArray} getOptionLabel={(option) => option.label} onChange={(event, newValue) => handleWadeNameSChange(newValue)} renderInput={(params) => <TextField {...params} label="WaDE Site Type CV" placeholder="WaDE Site Type CV" />}></Autocomplete>
      </Box>
